...
class TransactionReceivableEntries extends StatefulWidget {
  @override
  _TransactionReceivableEntriesState createState() =>
      _TransactionReceivableEntriesState();
}

class _TransactionReceivableEntriesState
    extends State<TransactionReceivableEntries> {
  MyTransectionModel model;
  List<MyTransectionModel> list = [];
  String type = "Receivable";


  myReceivableView(int eventId) async {
    setState(() {
      onProgress=true;
    });
  ...
  getTransectionData() async {
    ...
    final data = await Provider.of<MyTransectionprovider>(context, listen: false).getMyRecievableEntries();
                                    ...
                                    child: ListTile(
                                        ...
                                        leading: Column(
                                          ...
                                          children: [
                                            ...
                                            transection[index].formatedDate !=
                                                    null
                                                ? Text(
                                                    transection[index]
                                                        .formatedDate,
                                                          ...
                                                          onPressed: () {
                                                            ...
                                                            CustomHttpRequests.deleteList(
                                                                ...
                                                                .then((value) =>
                                                                    value);
                                                            setState(() {
                                                              // Provider.of<MyTransectionprovider>(context,listen: false).deleteReceivable();
                                                              transection
                                                                  .removeAt(
                                                                      index);
                                                            });
