  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        /*appBar: AppBar(
          ...
          centerTitle: true,
          title: Text("Starting Receivable",style: myStyle(16,Colors.white),),
        ),*/
                            ...
                            children: [
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "${model.receivableDetails[index].friendName??""}",style: myStyle(16,Colors.white,FontWeight.w600),
                                    ),
                                    SizedBox(height: 3,),
                                    Text(
                                      "${model.receivableDetails[index].date ?? ""}",style: myStyle(14,BrandColors.colorDimText,),
                                    )
                                  ],
                                ),
                              ),
                              Expanded(
                                  ...
                                  child: Text(
                                    ...
                                    NumberFormat.currency(
                                        symbol: ' ৳ ',
                                        decimalDigits: (model.receivableDetails[index]
                                            .amount) is int ? 0 :2,
                                        locale: "en-in").format(model.receivableDetails[index].amount),
                                    style: myStyle(
                                        14,model.receivableDetails[index].amount>1? Colors.greenAccent:Colors.redAccent),
                                  )
                              ),
                                      ...
                                      Text(
                                        NumberFormat.currency(
                                            ...
                                            decimalDigits: (model.receivableDetails[index]
                                                .amount) is int ? 0 :2,
                                            locale: "en-in")
                                            .format(model.receivableDetails[index]
                                            .amount),
                                    ...
                                    actions: <Widget>[
                                      ...
                                      FlatButton(
                                          onPressed: () {
                                            print("tap");
                                            CustomHttpRequests
                                                .deleteList(model.receivableDetails[
                                            index]
                                                .eventId)
                                                .then((value) =>
                                            value);
